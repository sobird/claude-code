 ...
 */
export function categoryToTier(category: DeniedCategory | null): 'read' | 'click' | 'full' {
 ...
 */
export function getDeniedCategoryByDisplayName(name: string): DeniedCategory | null {
 ...
 */
export function getDeniedCategoryForApp(bundleId: string | undefined, displayName: string): DeniedCategory | null {
  if (bundleId) {
 ...
 */
export function getDefaultTierForApp(bundleId: string | undefined, displayName: string): 'read' | 'click' | 'full' {
